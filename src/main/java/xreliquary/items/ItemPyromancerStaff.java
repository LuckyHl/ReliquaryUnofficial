 ...
 */
@ContentInit
public class ItemPyromancerStaff extends ItemToggleable implements xreliquary.api.INbtSyncTolerant {
    ...
    public static boolean isHoldToUse() {
        return Reliquary.CONFIG.getBool(Names.pyromancer_staff, "hold_to_use");
    }

    @Override
    public int getMaxItemUseDuration(ItemStack par1ItemStack) {
        return isHoldToUse() ? 72000 : 11;
    }
        ...
        if (player.isSneaking())
            ...
            if (getMode(ist).equals("blaze")) {
                ...
                if (getMode(ist).equals("eruption")
                        && !hasItemInInternalStorage(ist, Items.blaze_powder, getBlazePowderCost()))
                    return ist;
