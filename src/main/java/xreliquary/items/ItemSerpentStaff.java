...
@ContentInit
public class ItemSerpentStaff extends ItemBase implements xreliquary.api.INbtSyncTolerant {
    ...
    public static boolean isHoldToUse() {
        return Reliquary.CONFIG.getBool(Names.serpent_staff, "hold_to_use");
    }
