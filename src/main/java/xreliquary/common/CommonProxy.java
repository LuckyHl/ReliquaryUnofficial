...
//        }
    ...
    public void initOptions() {
        ...
        Reliquary.CONFIG.require(Names.fortune_coin, "hold_to_use", new ConfigReference(true));
        ...
        Reliquary.CONFIG.require(Names.pyromancer_staff, "hold_to_use", new ConfigReference(true));

        //serpent staff config
        Reliquary.CONFIG.require(Names.serpent_staff, "hold_to_use", new ConfigReference(true));
        ...
        Reliquary.CONFIG.require(Names.rending_gale, "hold_to_use", new ConfigReference(true));

        //mercy cross configs
        Reliquary.CONFIG.require(Names.mercy_cross, "undead_damage", new ConfigReference(24).setMinimumValue(0));
        Reliquary.CONFIG.require(Names.mercy_cross, "normal_damage", new ConfigReference(12).setMinimumValue(0));
        Reliquary.CONFIG.require(Names.mercy_cross, "show_particles", new ConfigReference(true));
